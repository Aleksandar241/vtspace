      ...
      <div className={styles.signupForm}>
        <Form className={styles.container}>
          ...
          <p className={styles.inputText}>
            Molimo vas da popunite sva polja kako bi završili registraciju. Nakon registracije na
            vaš email nalog će stići verifikacioni link. Nakon što se uspešno verifikujete možete se
            i prijaviti na VTSpace!
          </p>
